...
(library Library_1
	...
	(patternDef "VLMTG1500GS08" (originalName "VLMTG1500GS08")
		(multiLayer
			(pad (padNum 1) (padStyleRef r70_60) (pt -0.475, 0.000) (rotation 0))
			(pad (padNum 2) (padStyleRef r70_60) (pt 0.475, 0.000) (rotation 0))
		)
		...
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt -1.775 1.35) (pt 1.775 1.35) (width 0.1))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt 1.775 1.35) (pt 1.775 -1.35) (width 0.1))
		)
		...
		(layerContents (layerNumRef 18)
			(line (pt -1.375 0) (pt -1.375 0) (width 0.1))
		)
		(layerContents (layerNumRef 18)
			(arc (pt -1.325, 0) (radius 0.05) (startAngle 180) (sweepAngle 180.0) (width 0.1))
		)
		(layerContents (layerNumRef 18)
			(line (pt -1.275 0) (pt -1.275 0) (width 0.1))
		)
		(layerContents (layerNumRef 18)
			(arc (pt -1.325, 0) (radius 0.05) (startAngle .0) (sweepAngle 180.0) (width 0.1))
		)
	)
	(symbolDef "VLMTG1500-GS08" (originalName "VLMTG1500-GS08")
	...
	(compDef "VLMTG1500-GS08" (originalName "VLMTG1500-GS08") (compHeader (numPins 2) (numParts 1) (refDesPrefix LED)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "VLMTG1500-GS08"))
		(attachedPattern (patternNum 1) (patternName "VLMTG1500GS08")
			(numPads 2)
			(padPinMap
		...
		(attr "Mouser Part Number" "78-VLMTG1500-GS08")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Vishay/VLMTG1500-GS08?qs=MLItCLRbWszgBqjnjchDww%3D%3D")
		(attr "Manufacturer_Name" "Vishay")
		(attr "Manufacturer_Part_Number" "VLMTG1500-GS08")
		(attr "Description" "Green 528nm LED Indication - Discrete 2.8V 0402 (1005 Metric) ")
		(attr "<Hyperlink>" "https://www.vishay.com/doc?82554")
		(attr "<Component Height>" "0.35")
		(attr "<STEP Filename>" "VLMTG1500-GS08.stp")
